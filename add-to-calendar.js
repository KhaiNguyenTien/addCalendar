...
(function(exports) {
 ...
 var calendarGenerators = {
    ...
    google: function(event) {
      ...
      return '<a class="icon-test" target="_blank" href="' +
        href + '">'+'<span class="testtext">'+"Google"+'</span>'+'<em class="testtext1">'+" (online)"+'</em>'+'</a>';
    },
    ...
    yahoo: function(event) {
      ...
      return '<a class="icon-yahoo" target="_blank" href="' +
        href + '">'+'<span class="testtext">'+CONFIG.texts.yahoo+'<em class="testtext1">'+' (online)'+'</em>'+'</span>'+'</a>';
    },
    ...
    off365: function(event) {
      ...
      return '<a class="icon-off365" target="_blank" href="' +
        href + '">'+'<span class="testtext">'+CONFIG.texts.off365+'<em class="testtext1">'+' (online)'+'</em>'+'</span>'+'</a>';
    },
    outlookonline:function(event) {
      ...
      return '<a class="icon-outlookonline" target="_blank" href="' +
        href + '">'+'<span class="testtext">'+CONFIG.texts.outlookonline+'<em class="testtext1">'+' (online)'+'</em>'+'</span>'+'</a>';
    },
    ...
    ics: function(event, eClass, calendarName) {
      ...
      return '<a class="' + eClass + '" download="'+CONFIG.texts.download+'" href="' + 
        href + '">'+'<span class="testtext">' + calendarName + '</span>'+ '</a>';
  ...
  var generateMarkup = function(calendars, clazz, calendarId) {
    ...
    result.innerHTML = '<label for="checkbox-for-' +
      calendarId + '" class="add-to-calendar-label">'+'<span class="testtext2">'+CONFIG.texts.label+'</span>'+'</label>';
